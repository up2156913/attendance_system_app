...
echo "Setting up Liveness Detection for Facial Recognition Attendance System"
...
# Create the live_detection_module.py file
echo "Creating liveness detection module..."
cat > live_detection_module.py << 'EOL'
import cv2
import numpy as np
import time
...
echo "Liveness detection module has been created successfully!"
echo "To use the liveness detection feature, make sure to update your 1_Real_Time_Prediction.py file."
